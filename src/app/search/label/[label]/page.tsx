...
import { Tag, ArrowLeft, FileSearch } from "lucide-react";
import Link from "next/link";

export default function LabelPage({ params }: { params: Promise<{ label: string }> }) {
  ...
  useEffect(() => {
    params.then(p => {
      const decodedLabel = decodeURIComponent(p.label);
      setLabel(decodedLabel);
